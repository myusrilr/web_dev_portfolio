...
class Isuinfrastruktur extends BaseController {
        ...
        if(session()->get("logged_ga")){
            ...
            foreach ($list->getResult() as $row) {
                ...
                if($row->status == "Proses"){
                    ...
                    . '<br><br><button type="button" class="btn btn-sm btn-danger btn-fw" onclick="hapus('."'".$row->idproblem."'".','."'".$row->keterangan."'".')"><i class="fas fa-trash-alt"></i></button>'
                    . '</div>';
                    }
