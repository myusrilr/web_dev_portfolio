<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>perijinankaryawan/ajaxlist"
        });
    });
    ...
    function save() {
        ...
        var url = "";
        url = "<?php echo base_url(); ?>perijinankaryawan/submitnote";
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select class="custom-select" id="status" name="status">
                                ...
                                <option value="Diterima oleh Kepala Divisi">Diterima</option>
                                <option value="Ditolak oleh Kepala Divisi">Ditolak</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
