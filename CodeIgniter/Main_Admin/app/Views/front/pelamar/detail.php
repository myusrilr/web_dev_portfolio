...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>pelamarkaryawan/listnote/<?php echo $lamar->idpelamar; ?>",
            scrollY: 300,   
            scrollX: true,
        });
    });
    ...
    function hapus(id) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>pelamarkaryawan/hapusnote/" + id,
                        type: "POST",
                        dataType: "JSON",
                        error: function() {
                            alert('Error');
    ...
    function edit(id) {
        ...
        $('#form3').show();
        $.ajax({
            url: "<?php echo base_url(); ?>pelamarkaryawan/editing/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function simpan() {
        ...
        if(tot == 1){
            ...
            var url = "";
            url = "<?php echo base_url(); ?>pelamarkaryawan/submitpertanyaan";
    ...
    function showimg(jenis){
        ...
        var kode = document.getElementById('kode').value;
        $.ajax({
            url: "<?php echo base_url(); ?>pelamarkaryawan/load_gambar/" + kode+"/"+jenis,
            type: "GET",
            dataType: "JSON",
            success: function (data) {
