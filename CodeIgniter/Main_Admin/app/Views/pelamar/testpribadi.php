          ...
          <div class="col-lg-5 offset-lg-7">
            <div class="ufg-job-application-wrapper pt80">
              <div class="progress">
                ...
                <span class="step-text">3 of 3 completed</span></div>
              </div>
              <div class="form-steps active">
                <h3>Tes Kepribadian</h3>
                  Mohon membaca prosedur pengerjaan sampai akhir!!<br>
                <input type="hidden" value="<?php echo base_url().'/lamar/testkepribadian/'.$code ?>" id="myInput">
                <b>Copy link ini jika ingin mensubmit hasil nanti : <button onclick="copyy()">Copy text</button></b><hr></span>
                <center><b>Klik link berikut ini untuk mengerjakan Tes Kepribadian:</b> 
                <br><a href="https://www.16personalities.com/id/tes-kepribadian" target="_blank">https://www.16personalities.com/id/tes-kepribadian</a>
                </center><span>
                <ol>
                  <li>Baca dan ikuti petunjuk lebih lanjut dalam link tes yang disediakan</li>
                  <li>Pilih jawaban yang paling sesuai dengan kepribadian Anda, sesuai petunjuk tes</li>
                  <li>Kumpulkan hasilnya dalam bentuk Screenshoot tampilan layar hasil tesnya (kode tipe kepribadian dan hasil tes-nya)</li>
                  <li>Upload hasil screenshot tersebut pada form dibawah ini</li>
                </ol>
                Contoh hasil screenshot : <br>
                <img src="<?php echo base_url().'/uploads/tespribadi.jpeg'?>" height="200px" style="border: 1px solid #555;"><br><hr>
                </span>
                <div class="job-application-form">
                  ...
                  <button class="btn float-right" onclick="save()">SUBMIT</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      function save() {
        ...
        if(tot === 1){
            ...
            var url = "";
            url = "<?php echo base_url(); ?>lamar/submitpribadi";
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.status == "ok" || data.status == "ok_tanpa"){
                      window.location.href = '<?php echo base_url().'/lamar/done/' ?>'+data.id;
                    }
