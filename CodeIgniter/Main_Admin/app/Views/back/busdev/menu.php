                ...
                <ul class="sidenav-inner py-1">
                    ...
                    <li class="sidenav-item <?php if($menu == "bidang"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>bidang" class="sidenav-link">
                            <i class="sidenav-icon feather icon-layers"></i>
                            <div>Bidang Busdev</div>
                        </a>
                    </li>
                    <li class="sidenav-item <?php if($menu == "bidangkategori"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>bidangkategori" class="sidenav-link">
                            <i class="sidenav-icon feather icon-grid"></i>
                            <div>Kategori Bidang</div>
                        </a>
                    </li>
                    <li class="sidenav-item <?php if($menu == "bidanglink"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>bidanglink" class="sidenav-link">
                    ...
                    <li class="sidenav-item <?php if($menu == "penggunabusdev"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>penggunabusdev" class="sidenav-link">
                            <i class="sidenav-icon feather icon-users"></i>
                            <div>Karyawan Busdev</div>
                        </a>
                    </li>
                </ul>
            </div>
