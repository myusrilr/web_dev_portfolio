<script type="text/javascript">
    ...
    function hapus(id, nama) {
        swal({
            ...
            text:  "menghapus Divisi " + nama + " ini?",
...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">Divisi</h4>
                ...
                <form id="form">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <input type="text" id="judul" name="judul" class="form-control" placeholder="Masukkan nama Divisi" >
                            <small class="invalid-feedback">Nama Divisi wajib diisi</small>
                        </div>
                    </div>
                </form>
            </div>
