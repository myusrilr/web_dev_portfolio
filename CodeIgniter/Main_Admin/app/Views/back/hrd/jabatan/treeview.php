<style>
    ...
    .treeview > ul > li > ul > li > .treeview__level:before {
        height: 60px;
        width: 60px;
        top: -9.5px;
...
<script type="text/javascript">
    ...
    function reload() {
        $.ajax({
            url: "<?php echo base_url(); ?>jabatan/ajax_tree_view",
            method: "POST",
            dataType: "JSON",
            success: function (data) {
                $('#wadah_tree_view').html(data.status);
            }, error: function (jqXHR, textStatus, errorThrown) {
                alert("error", "Error json " + errorThrown);
            }
        });
    }
...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <div id="wadah_tree_view" class="treeview js-treeview">
