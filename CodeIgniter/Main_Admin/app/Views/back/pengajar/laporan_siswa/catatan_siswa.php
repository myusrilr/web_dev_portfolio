<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>laporansiswapengajar/ajaxcatatansiswa/<?php echo $head->idjadwal; ?>"
        });
    });

    function detil(kode, kodejadwal){
        window.location.href = "<?php echo base_url(); ?>laporansiswapengajar/detilcatatansiswa/" + kode + "/" + kodejadwal;
    }
...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>homepengajar">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>laporansiswapengajar">List Jadwal Pengajaran</a></li>
