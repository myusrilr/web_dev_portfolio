...
<body>
    ...
    <main style="font-size: 12px;">
        ...
        <hr>
        <h2 style="text-align: center;">LAPORAN SISWA KELUAR</h2>
        ...
        <table style="font-size: 11px; font-family: Arial; width: 100%; margin-top: 20px; border-collapse: collapse; border: 1px solid black;" border="1">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center; vertical-align: middle; padding:5px;">No Induk</th>
                    ...
                    <th style="text-align: center; vertical-align: middle; padding:5px;">Alasan Keluar</th>
                </tr>
            </thead>
            <tbody>
                <?php echo $isitable; ?>
