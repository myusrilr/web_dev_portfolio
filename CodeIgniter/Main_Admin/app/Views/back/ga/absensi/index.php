<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>absencega/ajaxlist"
        });

        table2 = $('#tb2').DataTable({
            ajax: "<?php echo base_url(); ?>absencega/ajaxlistnote"
        });
    ...
    function save() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>absencega/ajax_upload",
            dataType: 'JSON',
            cache: false,
            contentType: false,
            processData: false,
    ...
    function save2() {
        ...
        var url = "";
        url = "<?php echo base_url(); ?>absencega/submitnote";
    ...
    function verif(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>absencega/karyawan/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function saveverif() {
        ...
        var url = "";
        url = "<?php echo base_url(); ?>absencega/saveverif";
    ...
    function hapus(id, nama) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>absencega/hapus/" + id,
                        type: "POST",
                        dataType: "JSON",
                        error: function() {
                            alert('Error');
    ...
    function saveverifbulk() {
        ...
        var url = "";
        url = "<?php echo base_url(); ?>absencega/saveverifbulk";
    ...
    function delet(id, nama) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>absencega/delet/" + id,
                        type: "POST",
                        dataType: "JSON",
                        error: function() {
                            alert('Error');
    ...
    //                 $.ajax({
    //                     url: "<?php echo base_url(); ?>absencega/hapusall/",
    //                     dataType: 'JSON',
    //                     type: 'POST',
    //                     data: { kode: kodeabsen },
    //                     error: function() {
        ...
        <div class="col-xl-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <!-- <button type="button" class="btn btn-danger btn-sm" onclick="deleteall();">Hapus</button> -->
                    <div class="card-datatable table-responsive">
