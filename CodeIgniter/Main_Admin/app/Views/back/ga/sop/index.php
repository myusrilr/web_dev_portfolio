<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>sopga/ajaxlist"
        });
    ...
    function save() {
        ...
        if(tot === 3){
            ...
            var url = "";
            if (save_method === 'add') {
                url = "<?php echo base_url(); ?>sopga/ajax_add";
            } else {
                url = "<?php echo base_url(); ?>sopga/ajax_edit";
            }
    ...
    function hapus(id, nama) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>sopga/hapus/" + id,
                        type: "POST",
                        dataType: "JSON",
                        error: function() {
                            alert('Error');
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>sopga/ganti/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
