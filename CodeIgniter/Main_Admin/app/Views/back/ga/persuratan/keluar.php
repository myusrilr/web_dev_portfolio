<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>perijinansuratkeluar/ajaxlist"
        });
    });
    ...
    function add(id) {
        ...
        $('.modal-title').text('Persetujuan Surat Keluar');
    }
    ...
    function save() {
        ...
        var url = "";
        url = "<?php echo base_url(); ?>perijinansuratkeluar/submitnote";
    ...
    function ganti(id) {
        ...
        $('.modal-title').text('Persetujuan Surat Keluar');
        $.ajax({
            url: "<?php echo base_url(); ?>perijinansuratkeluar/ganti/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function hapus(id, nama) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>perijinansuratkeluar/hapus/" + id,
                        type: "POST",
                        dataType: "JSON",
                        error: function() {
                            alert('Error');
...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">Perijinan Surat Keluar</h4>
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><i class="feather icon-home"></i></li>
            <li class="breadcrumb-item active">Perijinan Surat Keluar</li>
        </ol>
    </div>
    <div class="row">
            ...
            <div class="modal-body">
                ...
                <form id="form">
                    ...
                    <div class="form-group">
                        ...
                        <small class="invalid-feedback">Nomor Surat Keluar wajib diisi</small>
                    </div>
                    <div class="form-row">
                        <div class="form-group col">
