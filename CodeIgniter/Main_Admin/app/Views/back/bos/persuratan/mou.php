<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>daftarmou/ajaxlist"
        });
    });
    ...
    function save() {
        ...
        var url = "";
        url = "<?php echo base_url(); ?>daftarmou/submitnote";
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>daftarmou/ganti/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select class="custom-select" id="status" name="status">
                                ...
                                <option value="Permintaan Disetujui">Permintaan Disetujui</option>
                                <option value="Terdapat Revisi">Terdapat Revisi</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col">
                            <label class="form-label">Catatan <i>*diisi ketika revisi</i></label>
