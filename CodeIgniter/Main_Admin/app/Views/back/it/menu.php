                ...
                <ul class="sidenav-inner py-1">
                    ...
                    <li class="sidenav-item <?php if($menu == "homeit"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>homeit" class="sidenav-link">
                    ...
                    <li class="sidenav-item <?php if($menu == "infrastruktur"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>infrastruktur" class="sidenav-link">
                            <i class="sidenav-icon feather icon-bar-chart-2"></i>
                            <div>Laporan Infrastruktur</div>
                        </a>
                    </li>
                    <li class="sidenav-item <?php if($menu == "isuinfrastrukturs"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>isuinfrastrukturs" class="sidenav-link">
                    ...
                    <li class="sidenav-item <?php if($menu == "listpindah"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>listpindah" class="sidenav-link">
                            <i class="sidenav-icon feather icon-check-square"></i>
                            <div>Perubahan Akses Akun</div>
                        </a>
                    </li>
                    <li class="sidenav-item <?php if($menu == "logaktifitas"){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>logaktifitas" class="sidenav-link">
                            <i class="sidenav-icon feather icon-cpu"></i>
